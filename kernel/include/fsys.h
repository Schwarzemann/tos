...
#define FSYS_FILE        0x01
#define FSYS_DIRECTORY   0x02
#define FSYS_CHARDEVICE  0x04
#define FSYS_BLOCKDEVICE 0x08
#define FSYS_PIPE        0x10
#define FSYS_SYMLINK     0x20
#define FSYS_MOUNTPOINT  0x40
